...
class ModalAgregarPlatosRequeridos extends StatelessWidget {
  final List<Plato> platosIniciales;
  final void Function(List<Plato>) onGuardar;

  const ModalAgregarPlatosRequeridos({Key? key, required this.platosIniciales, required this.onGuardar}) : super(key: key);
