...
class _ModalAgregarInsumosState extends State<ModalAgregarInsumos> {
  ...
  void _confirmarAgregar() {
    ...
    final yaExiste = _insumosSeleccionados.any(
      (iu) => iu.insumoId == _insumoActual!.id,
    );
    if (yaExiste) return;
    setState(() {
                        ...
                        insumoCtrl.loading
                            ...
                            : ListView.builder(
                              ...
                              itemBuilder: (context, idx) {
                                ...
                                final yaAgregado = _insumosSeleccionados.any(
                                  (iu) => iu.insumoId == insumo.id,
                                );
                                return ListTile(
                ...
                SizedBox(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, idx) {
                      ...
                      Insumo? insumo;
                      try {
                        insumo = insumoCtrl.insumos.firstWhere(
                          (x) => x.id == iu.insumoId,
                        );
                      } catch (_) {
                        insumo = null;
                      ...
                      return ListTile(
                        ...
                        subtitle: Text(
                          'Cantidad: ${iu.cantidad} ${insumo?.unidad ?? ''}',
                        ),
                        trailing: IconButton(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () {
                        ...
                        // Solo cerramos el modal, no navegamos más allá
